...
## 🚀 **NEW: Interactive Chat Interface + Google AI Studio Integration**

**ChatDev now features an interactive chat interface and uses Google AI Studio (Gemini models)!**

### 💬 **Interactive Chat Interface (Latest Feature)**
- 🗣️ **Natural Conversation**: Discuss your project ideas with an AI agent before development
- 🤔 **Smart Requirement Gathering**: AI asks clarifying questions to understand your needs
- 📝 **Automatic Task Generation**: Converts conversations into detailed development prompts
- 🚀 **Seamless Handoff**: Smooth transition from chat to development process
- 🎯 **User-Friendly**: Just run `python run.py --chat` or `python run.py` to start chatting!

### 🤖 **Google AI Studio Integration**
- 🔄 **Migrated from OpenAI to Google AI Studio API**
- 🤖 **Powered by Gemini 1.5 Flash and Gemini 1.5 Pro models**
- 💰 **More cost-effective with Google's competitive pricing**
- 🔧 **Smart fallback to local sentence-transformers when Google AI is unavailable**
- 💻 **Works offline with lightweight local embedding model (~90MB)**
- 🔑 **Set your `GOOGLE_API_KEY` environment variable to get started**
...
4. **Set Google AI Studio API Key:** Export your Google AI Studio API key as an environment variable. Replace `"your_Google_API_key"` with
   your actual API key from [Google AI Studio](https://aistudio.google.com/). Remember that this environment variable is session-specific, so you need to set it again if you
...
5. **Build Your Software:** Use the following command to initiate the building of your software,
   ...
   **💬 NEW: Interactive Chat Mode (Recommended for Beginners):**
   Instead of specifying the task directly, you can start an interactive conversation:
   ...
   **Example Chat Session:**
   ...
   👤 You: I want to build a simple calculator web app
   🤖 Great! What operations should it support?
   👤 You: Basic math operations with a clean interface
   🤖 Should it handle decimals and error cases?
   👤 You: Yes, let's start development
   ✅ Starting development of: Calculator_Web_App
   ```
