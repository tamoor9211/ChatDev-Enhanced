...
import os
import sys
# import openai  # Removed - now using Google AI Studio
import faiss
import numpy as np
...
class MemoryBase(ABC):
    def __init__(self, directory: str) -> None:
        ...
        if cfg.embedding_method == "GoogleAI" or cfg.embedding_method == "OpenAI":
            self.embedding_method = OpenAIEmbedding()  # This now uses GoogleAI backend
