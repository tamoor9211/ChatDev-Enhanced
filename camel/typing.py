...
class ModelType(Enum):
    ...
    def value_for_tiktoken(self):
        # For token counting, we'll use a default model since Gemini doesn't use tiktoken
        return "gpt-3.5-turbo-16k-0613" if self.name != "STUB" else "gpt-3.5-turbo-16k-0613"
