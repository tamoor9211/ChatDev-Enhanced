...
from camel.model_config import get_default_model_type
...
class RolePlaying:
    ...
    Args:
        ...
        model_type (ModelType, optional): The type of backend model to use.
            (default: :obj:`get_default_model_type()`)
    ...
    def __init__(
        ...
        self.model_type = model_type if model_type is not None else get_default_model_type()
