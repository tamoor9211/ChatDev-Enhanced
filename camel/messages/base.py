...
class BaseMessage:
    ...
    role: str
    content: str
    # Function calls and tool calls are not used with Google AI Studio
    ...
    def token_len(self, model: ModelType = ModelType.GEMINI_1_5_FLASH) -> int:
        ...
        Args:
            model (ModelType, optional): The model type to calculate the token
                length. (default: :obj:`ModelType.GEMINI_1_5_FLASH`)
